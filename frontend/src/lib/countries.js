...
export const COUNTRIES = [
  ...
  { code: "AR", name: "Argentina",     flag: "🇦🇷", timezone: "America/Argentina/Buenos_Aires", currency: "USD" },
  { code: "CL", name: "Chile",         flag: "🇨🇱", timezone: "America/Santiago",  currency: "USD" },
  { code: "CO", name: "Colombia",      flag: "🇨🇴", timezone: "America/Bogota",    currency: "USD" },
  ...
  { code: "PL", name: "Poland",        flag: "🇵🇱", timezone: "Europe/Warsaw",     currency: "EUR" },
  ...
  { code: "CZ", name: "Czech Republic",flag: "🇨🇿", timezone: "Europe/Prague",     currency: "EUR" },
  { code: "GR", name: "Greece",        flag: "🇬🇷", timezone: "Europe/Athens",     currency: "EUR" },
  { code: "TR", name: "Türkiye",       flag: "🇹🇷", timezone: "Europe/Istanbul",   currency: "EUR" },
  ...
  { code: "QA", name: "Qatar",         flag: "🇶🇦", timezone: "Asia/Qatar",        currency: "USD" },
  { code: "KW", name: "Kuwait",        flag: "🇰🇼", timezone: "Asia/Kuwait",       currency: "USD" },
  { code: "BH", name: "Bahrain",       flag: "🇧🇭", timezone: "Asia/Bahrain",      currency: "USD" },
  { code: "OM", name: "Oman",          flag: "🇴🇲", timezone: "Asia/Muscat",       currency: "USD" },
  { code: "IL", name: "Israel",        flag: "🇮🇱", timezone: "Asia/Jerusalem",    currency: "USD" },

  // Asia
  { code: "IN", name: "India",         flag: "🇮🇳", timezone: "Asia/Kolkata",      currency: "INR" },
  { code: "PK", name: "Pakistan",      flag: "🇵🇰", timezone: "Asia/Karachi",      currency: "USD" },
  { code: "BD", name: "Bangladesh",    flag: "🇧🇩", timezone: "Asia/Dhaka",        currency: "USD" },
  { code: "LK", name: "Sri Lanka",     flag: "🇱🇰", timezone: "Asia/Colombo",      currency: "USD" },
  { code: "NP", name: "Nepal",         flag: "🇳🇵", timezone: "Asia/Kathmandu",    currency: "USD" },
  ...
  { code: "VN", name: "Vietnam",       flag: "🇻🇳", timezone: "Asia/Ho_Chi_Minh",  currency: "USD" },
  { code: "HK", name: "Hong Kong",     flag: "🇭🇰", timezone: "Asia/Hong_Kong",    currency: "HKD" },
  { code: "TW", name: "Taiwan",        flag: "🇹🇼", timezone: "Asia/Taipei",       currency: "USD" },
  ...
  { code: "NG", name: "Nigeria",       flag: "🇳🇬", timezone: "Africa/Lagos",      currency: "USD" },
  { code: "KE", name: "Kenya",         flag: "🇰🇪", timezone: "Africa/Nairobi",    currency: "USD" },
  { code: "EG", name: "Egypt",         flag: "🇪🇬", timezone: "Africa/Cairo",      currency: "USD" },
  { code: "MA", name: "Morocco",       flag: "🇲🇦", timezone: "Africa/Casablanca", currency: "EUR" },
  { code: "GH", name: "Ghana",         flag: "🇬🇭", timezone: "Africa/Accra",      currency: "USD" },
];

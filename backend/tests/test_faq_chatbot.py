...
async def test_faq_ask_persists_visitor_and_bot_messages():
...
async def test_faq_ask_escalates_when_token_present():
    sid = _make_session_id()
    fake_chat = AsyncMock()
...
async def test_faq_escalate_flips_session_status_to_open():
    sid = _make_session_id()
